...
使用 `create-yss-harness-frontend` 首版候选；发布前先从 CLI 仓库的 tgz 本地安装验收，npm 可用状态以 registry 为准。

```sh
npx create-yss-harness-frontend@latest init --target-dir /absolute/path/to/equipment-project --project-name "设备借用"
```
