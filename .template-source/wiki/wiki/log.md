...
## [2026-08-27] REFRESH | 退役旧生命周期入口并对齐五阶段
...
- changed: AGENTS.md, CONTEXT.md, README.md, skills-maintenance.md, yss-skill-registry.yaml, vertical-slice-ticket-template.md, skills-lock.json, skill-migrations.md, yss-public-skills.json
- articles: 模板总览, 仓库身份与路由, Agent入口规则, 产品研发生命周期, 影响面分诊与流程裁剪, 模板维护流程, 切片实现合同, YSS路由与合同编译, YSS工程技能体系, 技能投影与锁定, LLM Wiki, Fresh验证与独立审查
